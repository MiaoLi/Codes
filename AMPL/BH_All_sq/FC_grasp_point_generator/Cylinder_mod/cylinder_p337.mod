...
# Print the solution  
display solve_message  >>  sol_cylinder_p337.txt ;
print 'Solve time:' >>  sol_cylinder_p337.txt ;
display _solve_time   >>  sol_cylinder_p337.txt ;
print 'Objective:'  >>  sol_cylinder_p337.txt ;
display  p   >>  sol_cylinder_p337.txt ;
display phi  >>  sol_cylinder_p337.txt ;
display l  >>  sol_cylinder_p337.txt ;
display np  >>  sol_cylinder_p337.txt ;
display vp  >>  sol_cylinder_p337.txt ;
