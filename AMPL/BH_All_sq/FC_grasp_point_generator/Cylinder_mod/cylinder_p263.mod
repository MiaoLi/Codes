...
# Print the solution  
display solve_message  >>  sol_cylinder_p263.txt ;
print 'Solve time:' >>  sol_cylinder_p263.txt ;
display _solve_time   >>  sol_cylinder_p263.txt ;
print 'Objective:'  >>  sol_cylinder_p263.txt ;
display  p   >>  sol_cylinder_p263.txt ;
display phi  >>  sol_cylinder_p263.txt ;
display l  >>  sol_cylinder_p263.txt ;
display np  >>  sol_cylinder_p263.txt ;
display vp  >>  sol_cylinder_p263.txt ;
