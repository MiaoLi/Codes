...
# Print the solution 
display solve_message  >>  sol_cylinder_p1_o266.txt ;
print 'Solve time:' >>  sol_cylinder_p1_o266.txt ;
display _solve_time  >>  sol_cylinder_p1_o266.txt ;
print 'Objective:' >>  sol_cylinder_p1_o266.txt ;
display torque  >>  sol_cylinder_p1_o266.txt ;
display cnh1  >>  sol_cylinder_p1_o266.txt ;
display cnh2 >>  sol_cylinder_p1_o266.txt ;
display cnh3 >>  sol_cylinder_p1_o266.txt ;
display snh1 >>  sol_cylinder_p1_o266.txt ;
display snh2 >>  sol_cylinder_p1_o266.txt ;
display snh3  >>  sol_cylinder_p1_o266.txt ;
display Hx  >>  sol_cylinder_p1_o266.txt ;
display Hy  >>  sol_cylinder_p1_o266.txt ;
display Hz   >>  sol_cylinder_p1_o266.txt ;
display cnf11 >>  sol_cylinder_p1_o266.txt ;
display cnf21 >>  sol_cylinder_p1_o266.txt ;
display cnf31  >>  sol_cylinder_p1_o266.txt ;
display cnf12 >>  sol_cylinder_p1_o266.txt ;
display cnf22  >>  sol_cylinder_p1_o266.txt ;
display cnf32  >>  sol_cylinder_p1_o266.txt ;
display cnt1 >>  sol_cylinder_p1_o266.txt ;
display cnt2 >>  sol_cylinder_p1_o266.txt ;
display snf11  >>  sol_cylinder_p1_o266.txt ;
display snf21  >>  sol_cylinder_p1_o266.txt ;
display snf31 >>  sol_cylinder_p1_o266.txt ;
display snf12 >>  sol_cylinder_p1_o266.txt ;
display snf22 >>  sol_cylinder_p1_o266.txt ;
display snf32  >>  sol_cylinder_p1_o266.txt ;
display snt1 >>  sol_cylinder_p1_o266.txt ;
display snt2  >>  sol_cylinder_p1_o266.txt ;
display  p  >>  sol_cylinder_p1_o266.txt ;
display mf >>  sol_cylinder_p1_o266.txt ;
display mt  >>  sol_cylinder_p1_o266.txt ;
display phi  >>  sol_cylinder_p1_o266.txt ;
display l >>  sol_cylinder_p1_o266.txt ;
display {i in 1..nb_segments, j in 1..1, k in 1..3} W[i,j,k]  >>  sol_cylinder_p1_o266.txt ;
display {i in 1..nb_segments, j in 1..1, k in 4..6} W[i,j,k]   >>  sol_cylinder_p1_o266.txt ;
display {i in 1..nb_segments, j in 2..2, k in 1..3} W[i,j,k]   >>  sol_cylinder_p1_o266.txt ;
display {i in 1..nb_segments, j in 2..2, k in 4..6} W[i,j,k]   >>  sol_cylinder_p1_o266.txt ;
display {i in 1..nb_segments, j in 3..3, k in 1..3} W[i,j,k]   >>  sol_cylinder_p1_o266.txt ;
display {i in 1..nb_segments, j in 3..3, k in 4..6} W[i,j,k]   >>  sol_cylinder_p1_o266.txt ;
display f11  >>  sol_cylinder_p1_o266.txt ;
display f12 >>  sol_cylinder_p1_o266.txt ;
display f13  >>  sol_cylinder_p1_o266.txt ;
display f21  >>  sol_cylinder_p1_o266.txt ;
display f22 >>  sol_cylinder_p1_o266.txt ;
display f23  >>  sol_cylinder_p1_o266.txt ;
display f31 >>  sol_cylinder_p1_o266.txt ;
display f32  >>  sol_cylinder_p1_o266.txt ;
display f33  >>  sol_cylinder_p1_o266.txt ;
