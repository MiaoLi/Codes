...
display phi 
display l
display {i in 1..nb_segments, j in 1..1, k in 1..3} W[i,j,k] 
display {i in 1..nb_segments, j in 1..1, k in 4..6} W[i,j,k]  
display {i in 1..nb_segments, j in 2..2, k in 1..3} W[i,j,k]  
display {i in 1..nb_segments, j in 2..2, k in 4..6} W[i,j,k]  
display {i in 1..nb_segments, j in 3..3, k in 1..3} W[i,j,k]  
display {i in 1..nb_segments, j in 3..3, k in 4..6} W[i,j,k]  
display f11 
display f12
display f13 
display f21 
