...
param mu := 1; #coefficient de frottement 
...
# Print the solution 
display solve_message  >>  point.txt ;
print 'Solve time:' >>  point.txt ;
display _solve_time  >>  point.txt ;
print 'Objective:' >>  point.txt ;
display  p  >>  point.txt ;
display phi  >>  point.txt ;
display l >>  point.txt ;
display np >>  point.txt ;
display vp >>  point.txt ;
